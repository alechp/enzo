...
export const companies: Company[] = [
  ...
  { name: 'ElevenLabs', url: 'https://elevenlabs.io', segment: 'ancillary', status: 'private', statusLabel: 'Private', capitalRaised: '~$280M+', valuation: '~$6.6B', position: 'Voice/audio layer for video pipelines', tags: ['ancillary', 'private'] },
